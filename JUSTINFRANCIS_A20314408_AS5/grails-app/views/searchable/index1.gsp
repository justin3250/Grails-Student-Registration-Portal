...
<title><g:if test="${params.q && params.q?.trim() != ''}">
		${params.q} - </g:if>Search Results</title>
	...
	<div class="alert alert-success text-center">
		...
		<div id="main">
			...
			<div class="title">
				<span> <g:if test="${haveQuery && haveResults}">
						<g:if test="${searchResult.results.size()>5}">
         Showing top 5 results for <strong> ${params.q}
							</strong>
						</g:if>
						<g:else>
        ...
        &nbsp;
			...
			<g:if test="${haveQuery && !haveResults && !parseException}">
				<p>
					No courses or course descriptions found having the keyword - <strong>
						${params.q}
					</strong>. Please try another keyword
				</p>
        ...
        -->
			...
			<g:if test="${searchResult?.suggestedQuery}">
				<p>
					Did you mean
					<g:link controller="searchable" action="index1"
					...
					<g:if test="${LuceneUtils.queryHasSpecialCharacters(params.q)}">
						<li>Remove special characters like <strong>" - [ ]</strong>,
							before searching, eg, <em><strong> ${LuceneUtils.cleanQuery(params.q)}
								...
								helper method for this: <g:link controller="searchable"
									action="index1" params="[q: LuceneUtils.cleanQuery(params.q)]">Search again with special characters removed</g:link></em>
						</li>
						<li>Escape special characters like <strong>" - [ ]</strong>
							with <strong>\</strong>, eg, <em><strong> ${LuceneUtils.escapeQuery(params.q)}
								...
								helper method for this: <g:link controller="searchable"
									action="index1" params="[q: LuceneUtils.escapeQuery(params.q)]">Search again with special characters escaped</g:link></em><br />
							<em>Or use the Searchable Plugin's <strong>escape</strong>
								option: <g:link controller="searchable" action="index1"
